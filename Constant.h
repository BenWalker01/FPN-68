...
#define AXES_COLOUR RGB(229, 186, 129)
#define GLIDESLOPE_COLOUR RGB(152, 233, 230)
#define TRACK_DEVIATION_COLOUR RGB(123, 204, 239)
#define BACKGROUND_COLOUR RGB(48, 50, 67)
#define PRIMARY_COLOUR RGB(245, 245, 245)
